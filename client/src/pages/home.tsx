...
const Home = () => {
  ...
  return (
    <Box>
       ...
       <Stack gap={5} mt="25px" width="100%" direction={{ xs: 'column', lg: 'row' }}>
        <TotalRevenue />
        <PropertyReferrals />
       </Stack>

       <Box flex={1} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" flexDirection="column" minWidth="100%" mt="25px">
